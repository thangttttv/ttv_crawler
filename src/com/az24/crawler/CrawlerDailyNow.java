...
public class CrawlerDailyNow implements Runnable {
	...
	public CrawlerDailyNow(String beanconfig, String jdbmconfig, String urlconfig,
	...
	private  void runStepOne(int step)
	{
		if(step==0||step==1){
	...
	public static void main(String[] args) {
		...
		for (Thread thread : threads) {
			CrawlerDailyNow crawlerDaily = new CrawlerDailyNow(thread.getBean_config(),
