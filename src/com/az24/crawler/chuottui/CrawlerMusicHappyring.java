...
public class CrawlerMusicHappyring {
	...
	public void collectionLink(String url,int cate_parent_id,int category_id, int language,int type_zing,String nationality, int page) throws Exception {
		...
		if(url.indexOf("http://")==-1) url = "http://happyring.vietnamobile.com.vn"+url;
		...
		String xpath__tag= "//TABLE[@id='row']/TBODY[1]/TR";
		...
		while (i <= node_one_many) {
			String m_title = (String) reader.read(xpath__tag+"["+ i + "]/TD[2]/text()", XPathConstants.STRING);
			String m_singer = (String) reader.read(xpath__tag+"["+ i + "]/TD[3]/text()", XPathConstants.STRING);
	...
	public static void main(String[] args) {
		CrawlerMusicHappyring crawlerMusicZing = new CrawlerMusicHappyring();
		MusicSource.initSourceLinkHappyring();
