...
public class CrawlerMusicMobi {
	...
	public void collectionLink(String url,int cate_parent_id,int category_id, int language,int type_zing,String nationality, int page) throws Exception {
		if(url.indexOf("http://")==-1) url = "http://www.funring.vn/"+url;
		...
		String xpath__tag= "//tr[@id='cc']/td[1]/table[1]/TBODY[1]/tr";
		...
		while (i <= node_one_many) {
			String  m_code_mback = (String) reader.read(xpath__tag+"["+ i + "]/td[1]/text()", XPathConstants.STRING);
			String m_title  = (String) reader.read(xpath__tag+"["+ i + "]/td[2]/span[1]/text()", XPathConstants.STRING);
			String m_singer = (String) reader.read(xpath__tag+"["+ i + "]/td[2]/span[2]/text()", XPathConstants.STRING);
	...
	public static void main(String[] args) {
		CrawlerMusicMobi crawlerMusicZing = new CrawlerMusicMobi();
		MusicSource.initSourceLinkFunring();
