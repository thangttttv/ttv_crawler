...
public class CrawlerStoresMay12 {
	...
	public void getCategoryInAz24(String urlExcelMap) throws BiffException,
		...
		//URL url = CrawlerStoresMay12.class.getResource(urlExcelMap);
	...
	public static void main(String[] args) throws Exception {
		CrawlerStoresMay12 crawlerStore = new CrawlerStoresMay12();
		...
		if (file.isDirectory()) {
			for (File child : file.listFiles()) {
				...
				if (child.isFile()) {
					...
					cagegoryDAO.update(crawlerStore
							.readExcelCategory("/data/crawler/conf/stores/"
									+ child.getName()));
					List<Url> urlCate = null;
					crawlerStore.getCategoryInAz24("az24_cate.xls");
					switch (type) {
					case 1:
						urlCate = categoryExtractor.extractCategoryGHType1(urlGH,
								store_id, false);
						break;
					case 2:
						urlCate = categoryExtractor.extractCategoryGHType2(
								urlGH, store_id, false);
						break;
					case 3:
						urlCate = categoryExtractor.extractCategoryGHType3(
								urlGH, store_id, false);
						break;
					case 4:
						urlCate = categoryExtractor.extractCategoryGHType4(
								urlGH, store_id, false);
						break;
					default:
						urlCate = categoryExtractor.extractCategoryGHType1(urlGH,
					...
					crawlerStore.extractProductGH(urlCate, store_id,
							store_alias, store_alias_n);
					i++;
