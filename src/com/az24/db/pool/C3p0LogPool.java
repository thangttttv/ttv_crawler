	...
	private static DataSource setupDataSource() {
		...
		try {
			...
			unpooled = DataSources
					.unpooledDataSource(
							"jdbc:mysql://192.168.1.101:3306/crawler?autoReconnect=true&characterEncoding=UTF-8",
							"aZ2$CraWleR", "Az@$crawLER!@%$#");
			
			/*unpooled = DataSources
			.unpooledDataSource("jdbc:mysql://210.211.97.11:3306/crawler?autoReconnect=true&characterEncoding=UTF-8",
					"quangpn", "@!!!quang!(*^");*/
			/*unpooled = DataSources
			.unpooledDataSource("jdbc:mysql://localhost:3306/crawler?autoReconnect=true&characterEncoding=UTF-8",
					"root", "");*/
